...
const ElectronicsBrandModelSection = ({
  filters,
  setFilters,
  expandedSections,
  toggleSection,
    ...
    try {
      ...
      if (filters.subcategory_id) {
        ...
        response = await api.get(
          `/electronic/brands?subcategory_id=${filters.subcategory_id}`);
      } else {
        // Use GET request without subcategory_id
        response = await api.get("/electronic/brands");
      }
  ...
  const fetchModels = async (brandId) => {
    ...
    try {
      const response = await api.post("/electronic/models/by-brand", {
        brand_id: brandId,
        // ...(filters.subcategory_id && {
                ...
                return (
                  ...
                  >
                    ...
                    <label className="text-sm cursor-pointer flex-1">
                      {brand.name} ({formatCount(brand.electronics_count)})
                    </label>
                  </div>
                );
              })
              ...
              filteredModels.map((model) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <label className="text-sm cursor-pointer flex-1">
                      {model.name} ({formatCount(model.electronics_count)})
                    </label>
                  </div>
                );
              })
...
export default ElectronicsBrandModelSection;
