  ...
  toggleSection,
   ...
   const [transmissionTypes, setTransmissionTypes] = useState([]);
    ...
    const fetchTransmissionTypes = async () => {
      ...
      try {
        console.log(
          "🔄 Fetching transmission types from /BIKE/get/transmission..."
        );
        const response = await api.get("/bike/get/transmission");
...
export default BikeTransmissionFilter