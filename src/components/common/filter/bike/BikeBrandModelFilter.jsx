...
const BikeBrandModelFilter = ({
  ...
  const [brands, setBrands] = useState([]);
       ...
       try {
         ...
         if (filters.subcategory_id) {
           ...
           response = await api.get(
             `/bike/get/brands?subcategory_id=${filters.subcategory_id}`
           );
         } else {
           // Use GET request without subcategory_id
           response = await api.get("/bike/get/brands");
         }
     ...
     const fetchModels = async (brandId) => {
       ...
       try {
         const response = await api.post("/bike/get/models/by-brand", {
           brand_id: brandId,
           // ...(filters.subcategory_id && {
                   ...
                   return (
                     ...
                     >
                       ...
                       <label className="text-sm cursor-pointer flex-1">
                         {brand.name} ({formatCount(brand.bike_count)})
                       </label>
                     </div>
                   );
                 })
                 ...
                 filteredModels.map((model) => {
                   ...
                   return (
                     ...
                     >
                       ...
                       />
                       <label className="text-sm cursor-pointer flex-1">
                         {model.name} ({formatCount(model.bike_count)})
                       </label>
                     </div>
                   );
                 })
...
export default BikeBrandModelFilter;
