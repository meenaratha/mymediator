...
const rentshopofficeformSlice = createSlice({
 name:'rentshopofficeform',
 initialState,
 reducers:{
 ...
 export const { 
    ...
    removeFile,
    clearFiles,
    resetForm, } = rentshopofficeformSlice.actions;
 export default rentshopofficeformSlice.reducer;
