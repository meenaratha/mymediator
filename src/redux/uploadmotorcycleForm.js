...
const uploadmotorcycleformSlice = createSlice({
 name:'uploadmotorcycleform',
 initialState,
 reducers:{
 ...
 export const { 
    ...
    removeFile,
    clearFiles,
    resetForm, } = uploadmotorcycleformSlice.actions;
 export default uploadmotorcycleformSlice.reducer;
